...
- AI 자율주행/로봇: 자율주행, 협동·서비스·산업 로봇, 자율 운영 시스템, 무인 차량/선박
...
- 기타 AI: AI 사업이 맞으나 위 분류에 명확히 안 맞는 경우 (라이선스 단순 구매, 추상적 AI 솔루션 등)
- 무관: AI 사업이 아닌 것. AI 시설·건물 건축/인테리어/전기/기계/감리 공사, "AIP"(항공정보간행물)·"AIS"(선박항행정보) 같은 약어 false positive, AI와 무관한 단순 비품 구매
