    ...
    <section className="relative flex flex-col overflow-hidden" style={{ height: "100svh", minHeight: "600px" }}>
      ...
      <div className="relative flex-1 flex flex-col items-center justify-center container mx-auto px-4 text-center">
        <div className="w-full text-center">
          ...
          <h1 className="font-bold text-white drop-shadow-lg mb-4" style={{ fontSize: "clamp(5rem, 15vw, 11rem)", letterSpacing: "-0.03em", lineHeight: 0.95, fontFamily: "var(--font-display)", whiteSpace: "nowrap" }}>
            PUBLIC-AX
          </h1>
          <p className="text-lg md:text-xl text-white/80 mb-10 leading-relaxed max-w-xl mx-auto drop-shadow">
            AI는 어제도 달랐고, 오늘도 다릅니다
          </p>
          <div className="w-full px-4 mb-8 max-w-sm md:max-w-xl lg:max-w-2xl xl:max-w-3xl mx-auto">
            <HeroSearch />
          </div>
